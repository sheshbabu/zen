...
` || i === "\r" ? (s(), r = 2) : o += i), r === 3 && o === "!--" && (r = 4, c = c[0]);
  ...
  function NotesListToolbar({ onListViewClick, onGridViewClick }) {
    return /* @__PURE__ */ dt("div", { className: "notes-list-toolbar" }, /* @__PURE__ */ dt("div", { onClick: () => onListViewClick() }, /* @__PURE__ */ dt(ListViewIcon, null)), /* @__PURE__ */ dt("div", { onClick: () => onGridViewClick() }, /* @__PURE__ */ dt(GridViewIcon, null)));
  }
  ...
  // commons/utils/renderMarkdown.js
  ...
  function NotesList({ notes = [], view, onViewChange }) {
    let containerClassName = "notes-list-fragment";
    let listClassName = "notes-list";
    let items = notes.map((note) => /* @__PURE__ */ dt(NotesListItem, { note, key: note.NoteID }));
    if (view === "grid") {
      containerClassName = "notes-grid-fragment";
      listClassName = "notes-grid";
      items = notes.map((note) => /* @__PURE__ */ dt(NotesGridItem, { note, key: note.NoteID }));
    }
  ...
  function NotesGridItem({ note }) {
    ...
    return /* @__PURE__ */ dt("div", { className: "notes-grid-item" }, /* @__PURE__ */ dt(Link, { to: link }, title, /* @__PURE__ */ dt("div", { className: "notes-grid-item-content", dangerouslySetInnerHTML: { __html: renderMarkdown(note.Snippet) } })));
  }
  ...
  function Toolbar({ isEditable, isFloating, onSaveClick, onEditClick, onCloseClick }) {
    ...
    if (isEditable) {
      actions.push(
        /* @__PURE__ */ dt(CheckIcon, { className: "notes-editor-toolbar-button-done", onClick: onSaveClick })
      );
    } else {
      actions.push(
        /* @__PURE__ */ dt(PencilIcon, { className: "notes-editor-toolbar-button-edit", onClick: onEditClick })
      );
    }
